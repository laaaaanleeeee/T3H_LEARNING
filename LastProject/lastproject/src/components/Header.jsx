      ...
      <header className={`fixed top-0 left-0 w-full shadow-md p-2 z-50 transition-colors duration-300 ${bgClass}`}>
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <nav className="space-x-10">
            <NavLink
              to="/"
              className={({ isActive }) => (isActive ? 'text-orange-600 border-b-2 pb-2' : 'hover:text-orange-600')}
            >
              <b>Trang chủ</b>
            </NavLink>
            <NavLink
            ...
            <NavLink
              to="/booking"
              className={({ isActive }) => (isActive ? 'text-orange-600 pb-2' : 'hover:text-orange-600')}
            >
          ...
          <nav className="flex items-center space-x-10">
            <div className="relative">
              <div className="flex border-b-2 pb-2">
                ...
                {searchResult.length > 0 && (
                  <ul className="absolute top-full mt-2 z-50 bg-white w-fit shadow-lg">
                    {searchResult.map((item) => (
                      ...
                      >
                        <img className="w-15 m-2" src={item.thumbnail} alt={item.title} />
            ...
            >
              <Badge count={count} overflowCount={99} className="flex items-center justify-between">
                <button
                  type="button"
                  className="cursor-pointer text-xl text-orange-600 hover:text-blue-600"
                >
